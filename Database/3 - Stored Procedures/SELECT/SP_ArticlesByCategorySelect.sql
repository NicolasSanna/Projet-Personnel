...
BEGIN
    ...
    SELECT articles.id AS id_article , title, user_id, category_id, DATE_FORMAT(creation_date,  'Le %d/%m/%Y à %H:%i') AS creation_date, categories.id AS id_category, category, pseudo
    FROM articles
